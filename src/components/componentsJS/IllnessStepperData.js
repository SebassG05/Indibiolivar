...
export default function IllnessModelStepper() {
  ...
  const fetchIllnesses = async () => {
    try {
      const response = await fetch('http://localhost:5100/available_illnesses'); // Endpoint para obtener enfermedades disponibles
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('http://localhost:5100/illness_model', {
        method: 'POST',
        headers: {
